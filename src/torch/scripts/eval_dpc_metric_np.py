...
def p2plane_np(pc1, pc2, normal):
    ...
    xyz_range = xyz_max - xyz_min
    bounding_box_width = np.max(xyz_range)
    xyz_err = np.mean(projected_error / (3 * (bounding_box_width**2)))
