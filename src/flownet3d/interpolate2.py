...
if __name__ == "__main__":
    ...
    # source_dpc = FileBackedDynamicPointCloud("/home/jelmer/data/sceneflow_stable/Stefani_Capoeira", "/home/jelmer/data/sceneflow_stable/Stefani_Capoeira/frames.dpc")
    source_dpc = FileBackedDynamicPointCloud("/home/jelmer/data/test_set/stefani", "/home/jelmer/data/test_set/stefani/frames.dpc")
    # source_dpc = FileBackedDynamicPointCloud("/home/jelmer/data/test_set/malcolm", "/home/jelmer/data/test_set/malcolm/frames.dpc")

    # for pc in source_dpc:
    #     pc.normals = open3d.Vector3dVector([])

    # Output Dynamic Point Cloud
    # base_dir = osp.join("/home/jelmer/data/interpolated/rev_malcolm")
    base_dir = osp.join("/home/jelmer/data/interpolated/rev_stefani3")
    output_dpc = FileBackedDynamicPointCloud(base_dir, osp.join(base_dir, "frames.dpc"))
    naming_scheme = osp.join(base_dir, "frame_{0:06d}.ply")
